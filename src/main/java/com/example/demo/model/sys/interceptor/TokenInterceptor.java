package com.example.demo.model.sys.interceptor;
...
public class TokenInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        // 3. 校验Token是否存在
        ValueOperations<String, Object> tokenRedis = redisTemplate.opsForValue();
        TokenInfo tokenInfo = (TokenInfo) tokenRedis.get(token);

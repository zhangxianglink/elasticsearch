...
public class PowerController {
    ...
    /**
     * 对于下单等存在唯一主键的，可以使用 “唯一主键方案” 的方式实现。  插入操作
     *
     * 对于更新订单状态等相关的更新场景操作，使用 “乐观锁方案” 实现更为简单。 更新操作
     *
     * 对于上下游这种，下游请求上游，上游服务可以使用 “下游传递唯一序列号方案” 更为合理。 crud操作，需要第三方已存在数据在redis，下游提供唯一编号
     *
     * 类似于前端重复提交、重复下单、没有唯一 ID 号的场景，可以通过 Token 与 Redis 配合的 “防重 Token 方案” 实现更为快捷。crud操作
     */
